    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto ">
            ...
            <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full relative picbox1 cursor-poin ter">
                ...
                {content}
                <button disabled={isLoading} className="bg-black text-white rounded-md p-2 font-medium hover:bg-slate-600 w-full" onClick={handleAddBlog}>Add Blog</button>
            </div>
        </div>
    );
};
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full relative picbox1 cursor-pointer">
                ...
                <button disabled={isLoadingu} className="bg-black text-white rounded-md p-2 font-medium hover:bg-slate-600 w-full" onClick={handleUpdateBlog}>Update Blog</button>
            </div>
        </div>
    );
};
        ...
        <div>
            ...
            <div className="flex flex-col mt-6 containera  mx-auto">
                <div className="overflow-hidden border-b border-gray-200 rounded-md">
                    <h3 className="mt-6 text-2xl font-semibold pt-7 text-gray-400 hover-underline">Blogs  </h3>
                    <div className="flex justify-end">
                        <button className='bg-[#8cc230] text-black rounded-md p-2 font-medium hover:bg-[#a0ff00]' onClick={() => { navigate('/newblog') }} >Add New +</button>
                    </div>
