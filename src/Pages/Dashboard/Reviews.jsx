    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full relative picbox1 cursor-pointer">
                ...
                <button disabled={isLoading} className="bg-black text-white rounded-md p-2 font-medium hover:bg-slate-600 w-full" onClick={handleAddReview}>Add Review</button>
            </div>
        </div>
    );
};
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full relative picbox1 cursor-pointer">
                ...
                <button disabled={isLoadingu} className="bg-black text-white rounded-md p-2 font-medium hover:bg-slate-600 w-full" onClick={handleUpdateReview}>Update Review</button>
            </div>
        </div>
    );
};
