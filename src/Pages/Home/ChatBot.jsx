                            ...
                            <div className="flex-1 p:2 sm:p-2 justify-between flex flex-col h-[400px] bg-black rounded-2xl">
                                    ...
                                    <div className="chat-message">
                                        <div className="flex items-end">
                                            <div className="flex flex-col space-y-2 text-md max-w-xs mx-2 order-2 items-start">
                                                <div> <span className="px-4 py-2 rounded-lg inline-block  rounded-bl-none bg-gray-300 text-gray-900  font-[19px]">  Welcome to the HACKERverse® How may I help You? </span> </div> </div>
                                ...
                                <div className="  border-gray-200 px-1 pr-3 pt-2 mb-2 sm:mb-0 pb-2">
                                    <div className="relative flex">
                                        <input type="text" placeholder="Write your message!" className="ml-1 w-full focus:outline-none focus:placeholder-gray-400 font-medium text-gray-900 placeholder-gray-600 pl-3 bg-gray-200 rounded-md py-2" />
                                        <div className="absolute -right-1 items-center inset-y-0 hidden sm:flex">
                                            <button type="button" className="inline-flex items-center justify-center rounded-r-md  -md px-2 py-2 transition duration-500 ease-in-out text-white bg-[#1f7920] hover:bg-green-900 focus:outline-none" > <span className="font-bold"></span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6 ml-2 transform rotate-90" > <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" /> </svg> </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
