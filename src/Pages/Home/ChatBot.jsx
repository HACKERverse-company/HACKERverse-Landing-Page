                    ...
                    <div className="fixed bottom-[115px] right-4 w-80 h-[80px] bg-black  picboxc   rounded-2xl ">
                        <div className="flex justify-between items-center px-4 py-2  ">
                            <div className="relative flex items-center space-x-3 ">
                                ...
                                <div className="flex flex-col leading-tight"> <div className="text-3xl mb-2 items-center "><span className="text-white   text-lg  " style={{ fontSize: '20px' }}><b>Hey, Chat with me!</b></span> </div>   </div>
                            </div>
                        </div>
                    </div>
                )}
