      ...
      <section className="bg-transparent">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:px-6">
          <div className="mx-auto max-w-screen-sm">
            <h2 className="mb-2 text-3xl tracking-tight font-extrabold hover-underline text-white uppercase font-rubik dark:text-white">
              Our Testimonials
            </h2>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        >
          {reviews.map((testimonial, index) => (
            <div
              key={index}
              className="max-w-xl h-[380px]  mt-12 mx-auto p-4 mb-14 cursor-pointer picbox1 rounded-2xl bg-[#1D1D1D]"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-base font-poppins text-[#a0ff00] font-bold mt-2.5">
                    {testimonial.designation}
                  </p>
                </div>
              </div>
              <div className="mt-4 text-center">
                <p className="text-lg font-poppins leading-relaxed text-gray-400">
                  {testimonial.review}
                </p>
              </div>
            </div>
