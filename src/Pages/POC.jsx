        ...
        script.onload = () => {
            if (window.hbspt) {
                window.hbspt.forms.create({
                    region: "na1",
                    portalId: "22582640",
                    formId: "93ff85dc-13b8-4998-9457-0c8858c65e1f",
    ...
    return (
        <>
            <div className='container mx-auto relative  bg-transparent '>
                <Link to="/" class="flex items-center absolute top-5 left-4 z-50 bg-slate-700 p-1 rounded-full pr-1">
                ...
                <section className=" ">
                    <div className="container px-2 py-12 mx-auto">
                        <div className="text-center ">
                            <p className="text-2xl  text-[#a0ff00] mt-4">Contact us</p>
                        ...
                        <img className="object-cover w-auto h-auto mt-10 rounded-lg  picbox1" src={img} alt="" />
                    </div>
                </section>

                <section className="text-gray-900 body-font relative">
                    <div className="container   py-4 mx-auto">
                        <div className="lg:w-1/2 md:w-2/3 mx-auto w-full bg-gray-900 p-4 rounded-2xl picbox1">
